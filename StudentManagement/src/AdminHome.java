...
public class AdminHome extends javax.swing.JFrame {
    ...
    // to insert into database using create button
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        String fname = (String) jTextField3.getText();
        
        try{
            Class.forName("com.mysql.jdbc.Driver");
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/stdmngsys","root","Hari@Sql18");
            Statement st = con.createStatement();
            st.executeUpdate("insert into student(cource,branch,rollNo,name,gender,fathername) values('"+course+"','"+branch+"','"+rollNo+"','"+name+"','"+gender+"','"+fname+"')");
